...
export default function SupportChat({ 
  ...
  return (
    <div className="flex flex-col lg:flex-row h-[calc(100vh-170px)] bg-[#0d0d0d] animate-in fade-in slide-in-from-right-4 duration-500">
      {/* Chat Area */}
          ...
          {messages.map((msg) => (
            ...
            >
              <div className={`flex items-end gap-3 max-w-[80%]`}>
                 ...
                 <div>
                    <div className={`p-6 rounded-[32px] text-sm lg:text-base leading-relaxed ${
                      msg.senderId === userId 

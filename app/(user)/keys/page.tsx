        ...
        {keys.length > 0 ? (
          keys.map((key) => (
            ...
            >
              ...
              <p className="text-(--text-main) text-xs font-bold uppercase tracking-widest mb-8">
          ...
          <div className="col-span-full py-20 text-center border-2 border-dashed border-(--bg-dark) rounded-[40px] bg-(--text-main)/[0.01]">
            <div className="w-20 h-20 bg-(--bg-dark) rounded-3xl flex items-center justify-center mx-auto mb-6 border border-(--text-main)/5">
            ...
            <Link
              href="/products"
              className="bg-(--accent) text-(--bg-dark) px-10 py-4 rounded-2xl font-bold text-sm hover:transform hover:scale-105 transition-all inline-block shadow-[0_0_20px_rgba(110,221,134,0.3)]"
            >
              Browse Products
            </Link>
          </div>

         ...
         <div className="flex items-center justify-between mb-10">
            <div>
               <div className="flex items-center gap-2 text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3">
                  ...
                  <ChevronRight size={12} />
                  <span className="text-[#6eDD86]">New Post</span>
               </div>
               <h1 className="text-4xl lg:text-5xl font-bold tracking-tight">
                  Create New <span className="text-[#6eDD86]">Blog Post</span>
               </h1>
            </div>
            ...
            <div className="col-span-12 lg:col-span-7 xl:col-span-8 space-y-8">
               ...
               <section className="bg-[#121212] border border-white/5 rounded-[32px] p-8">
                  <div className="mb-6">
                     ...
                     <input
                        ...
                        className="w-full bg-[#1a1a1a] border border-white/5 rounded-2xl p-5 text-sm outline-none focus:border-[#6eDD86]/30 transition-all placeholder:text-gray-600"
                     />
                  </div>
               ...
               <section className="bg-[#121212] border border-white/5 rounded-[32px] overflow-hidden">
                  ...
                  <div className="flex items-center justify-between px-6 py-4 border-b border-white/5">
                     <div className="flex items-center gap-1">
                        <button
                           ...
                           className="w-9 h-9 flex items-center justify-center rounded-lg text-gray-400 hover:text-white hover:bg-white/5 transition-all cursor-pointer"
                           title="Bold"
                        >
                           <Bold size={16} />
                        </button>
                  ...
                  <textarea
                     ...
                     className="w-full bg-transparent p-8 text-sm text-[#e2e2e2] outline-none resize-none min-h-[400px] placeholder:text-gray-700 leading-relaxed"
                  />
                  ...
                  <div className="flex items-center justify-between px-8 py-4 border-t border-white/5">
                     ...
                     <span className="text-[10px] font-bold text-[#6eDD86]">
                        {autosaved || ""}
                     </span>
                  </div>
               </section>
            ...
            <div className="col-span-12 lg:col-span-5 xl:col-span-4 space-y-8">
               ...
               <section className="bg-[#121212] border border-white/5 rounded-[32px] p-8">
                  ...
                  {formData.featuredImage ? (
                     <div className="relative rounded-2xl overflow-hidden">
                        ...
                        <button
                           ...
                           className="absolute top-3 right-3 w-8 h-8 bg-black/60 rounded-full flex items-center justify-center text-white hover:text-red-400 transition-colors cursor-pointer"
                        >
                           <X size={14} />
                        </button>
                     </div>
                  ) : (
                     <label className="flex flex-col items-center justify-center h-40 bg-[#1a1a1a] border-2 border-dashed border-[#6eDD86]/20 rounded-2xl cursor-pointer hover:bg-[#1f1f1f] hover:border-[#6eDD86]/40 transition-all group">
                        <Upload
                           size={28}
                           className="text-[#6eDD86] mb-3 group-hover:scale-110 transition-transform"
                        />
                  ...
                  <input
                     ...
                     className="w-full bg-[#1a1a1a] border border-white/5 rounded-xl p-3 text-xs outline-none focus:border-[#6eDD86]/30 transition-all mt-4 placeholder:text-gray-700"
                  />
               </section>

               {/* Metadata – Tags & SEO */}
               <section className="bg-[#121212] border border-white/5 rounded-[32px] p-8">
                  <h3 className="text-[10px] font-bold text-[#6eDD86] uppercase tracking-[0.2em] mb-6 flex items-center gap-2">
                  ...
                  <div className="mb-6">
                     ...
                     <div className="flex flex-wrap gap-2 mb-3">
                        {formData.tags.map((tag) => (
                           <span
                              key={tag}
                              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#6eDD86]/10 text-[#6eDD86] text-[10px] font-bold"
                           >
                              #{tag}
                              <button
                     ...
                     <div className="flex bg-[#1a1a1a] border border-white/5 rounded-xl overflow-hidden focus-within:border-[#6eDD86]/30 transition-all">
                        <input
                           type="text"
                           value={newTag}
                  ...
                  <div>
                     ...
                     <textarea
                        ...
                        maxLength={160}
                        className="w-full bg-[#1a1a1a] border border-white/5 rounded-xl p-3 text-xs outline-none focus:border-[#6eDD86]/30 transition-all resize-none placeholder:text-gray-700"
                     />
                  </div>
               </section>
               ...
               <section className="bg-[#121212] border border-white/5 rounded-[32px] p-8">
                  <h3 className="text-[10px] font-bold text-[#6eDD86] uppercase tracking-[0.2em] mb-6 flex items-center gap-2">
                     <Zap size={14} className="fill-[#6eDD86]" /> Status & Visibility
                  </h3>
                  ...
                  <div className="space-y-4">
                     <div className="flex items-center justify-between text-xs font-bold">
                        ...
                        <select
                           ...
                           className="bg-transparent text-[#6eDD86] text-right outline-none cursor-pointer appearance-none font-bold"
                        >
                      ...
                      <div className="flex flex-col gap-2 text-xs font-bold w-full">
                        <div className="flex items-center justify-between">
                            ...
                            <button 
                                ...
                                className="text-[#6eDD86] text-[9px] hover:underline"
                            >
                                Regenerate
                            </button>
                        </div>
                        <input 
                            ...
                            className="bg-[#1a1a1a] border border-white/5 rounded-xl p-3 text-[#6eDD86] font-mono text-[11px] outline-none focus:border-[#6eDD86]/30 transition-all"

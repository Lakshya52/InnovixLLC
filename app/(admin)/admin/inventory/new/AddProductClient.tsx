         ...
         <main className="flex-grow p-10 max-h-screen overflow-y-auto scrollbar-hide">
            ...
            <div className="grid grid-cols-12 gap-10">
               ...
               <div className="col-span-4 space-y-10">
                  ...
                  {/* Image Upload */}
                  <section className="bg-[#121212] border border-white/5 rounded-[40px] p-8">
                     <h3 className="text-[10px] font-bold text-[#6eDD86] tracking-[0.2em] uppercase mb-8">Product Image</h3>
                     ...
                     {imagePreview ? (
                        <div className="relative rounded-[24px] overflow-hidden mb-4">
                           ...
                           <button onClick={removeImage} className="absolute top-3 right-3 w-9 h-9 bg-black/70 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:text-red-400 hover:bg-black/90 transition-all cursor-pointer">
                              <X size={16} />
                           </button>
                           <div className="absolute bottom-3 left-3 px-3 py-1 bg-[#6eDD86]/90 rounded-full text-[9px] font-bold text-black uppercase tracking-wider">Image Ready</div>
                        </div>
                     ) : (
                        <div onClick={() => fileInputRef.current?.click()} className="aspect-[16/10] bg-[#1a1a1a] border-2 border-dashed border-white/10 rounded-[24px] flex flex-col items-center justify-center gap-4 group cursor-pointer hover:bg-[#1f1f1f] hover:border-[#6eDD86]/30 transition-all">
                           <div className="p-5 bg-[#0d0d0d] rounded-2xl border border-white/5 text-gray-600 group-hover:text-[#6eDD86] group-hover:scale-110 transition-all">
                              <Upload size={32} />
                           </div>
                     ...
                     <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center px-2">
                           <p className="text-[9px] font-bold text-gray-600 uppercase">
                              Detected: <span className="text-[#6eDD86]">{formData.initialKeys.split('\n').filter(k => k.trim()).length} keys</span>
                           </p>

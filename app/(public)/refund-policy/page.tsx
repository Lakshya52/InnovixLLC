  ...
  return (
    <div className="min-h-screen bg-(--bg-dark) text-(--text-main) pt-20 mt-[15dvh] pb-20 px-6">
      <div className="w-[80dvw] mx-auto">
        ...
        <p>
          To start a return, you can contact us at info@innovixllc.us. Please note that returns will need to be sent to the following address:
        </p> <br />
        <p>
        ...
        <p>
          You can always contact us for any return questions at info@innovixllc.us.
        </p> <br />

        <section className="space-y-8 text-sm md:text-base leading-relaxed text-(--text-main)/80">
          <div>
            <h2 className="text-2xl font-semibold text-(--text-main) mb-4">Damages and issues</h2>
            <p>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-(--text-main) mb-4">Exchanges</h2>
            ...
            <h2 className="text-2xl font-semibold text-(--text-main) mb-4">European Union 3 day cooling off period</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-(--text-main) mb-4">Refunds</h2>
            ...
            <p>If more than 15 business days have passed since we’ve approved your return, please contact us at info@innovixllc.us.</p> <br />
          </div>
        </section>
      </div>
    </div>
